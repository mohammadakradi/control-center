...
1. **Investigate** — read `.fe/notes.md` and `.fe/design-system.md`, reproduce the bug
...
4. **Independent review** — dispatch **both** the `design-reviewer` and the `frontend-auditor`
   subagents. Resolve all blocking findings and re-review until both are clean.
